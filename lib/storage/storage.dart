...
//     }
//
//     List<Subject> seminarWithoutGraduationEvaluation = (await SubjectService.findAll()).where((s) => s.subjectType == SubjectType.wSeminar && s.graduationEvaluation == null).toList();
//     for (Subject seminar in seminarWithoutGraduationEvaluation) {
//       GraduationEvaluationService.setGraduationEvaluation(seminar, GraduationEvaluationType.seminar);
//     }
//   }
//
