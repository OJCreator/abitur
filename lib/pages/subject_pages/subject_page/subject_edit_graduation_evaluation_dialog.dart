...
class _SubjectEditGraduationEvaluationDialogState extends State<SubjectEditGraduationEvaluationDialog> {
  ...
  late final Future<bool> secondGraduationDateAvailableFuture;
  ...
  void initState() {
    ...
    secondGraduationDateAvailableFuture = GraduationEvaluationService.canAddSecondGraduationDate(widget.graduationEvaluation);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: FutureBuilder(
        future: secondGraduationDateAvailableFuture,
  ...
  Future<void> _saveChanges() async {
    await GraduationEvaluationService.editEvaluation(
